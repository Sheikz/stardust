...
module.exports = "<div class=\"thumbnail shop-item\">\r\n  <img class=\"img-responsive\" ng-src=\"{{$ctrl.image}}\">\r\n  <h3>{{$ctrl.name}}</h3>\r\n  <p>{{$ctrl.description}}</p>\r\n  <button ng-click=\"$ctrl.click\" class=\"btn btn-primary\">Add to cart</button>\r\n</div>";

/***/ }),
/* 10 */
/***/ (function(module, exports) {

module.exports = "<div class=\"row\" ng-repeat=\"items in $ctrl.items | groupBy:4\">\r\n  <div class=\"col-xs-3\" ng-repeat=\"item in items\">\r\n    <shop-item name=\"item.name\" description=\"item.description\" image=\"item.image\"></shop-item>\r\n  </div>\r\n</div>";
